...
console.log("Postincrement result", result1--);
console.log("Now result holds the appropriate value:", result1);
...
console.log("Divided by 0 ", (452/0));
