// adding new elements, attributes to elements, or changing attributes
...
/*
    The following uses the Javascript Event System. addEventListener allows us to invoke a function when something happens on our webpage. In this case, we will call one of the functions below.
...
// choose the event and then function to run when event occurs
