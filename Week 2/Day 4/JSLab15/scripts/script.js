...
var removed = activityList.removeChild(removeMe);
...
function addName(eventColor){
    ...
    console.log(color);
    let inputColor = document.getElementById("colorValues");
    let nameElementColor = document.createElement("h3");
    nameElementColor.innerHTML =color;
    inputColor.appendChild(nameElementColor);
}
document.getElementById("formColorChild").addEventListener("submit", addName);
}
