...
var x =prompt("Give me a number for X.");
var y =prompt("What about a number for Y?");
function runFunctions(a) {
    console.log("I'm taking X.");
    a();
}
runFunctions(function(){
    console.log("....and mixing Kool-aid with Y.")
});
let z=(x*y);
console.log(x,"x")
console.log(y,"y")
...
let player2= new Player("Mark", "Video Games");
console.log(player2);